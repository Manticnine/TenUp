...
[Translation Process](https://github.com/tenup-coin/tenup/blob/master/doc/translation_process.md)
...
spread out over GitHub, forums, email, and Telegram discussions). The following
...
Where a patchset proposes to change the TenUp consensus, it must have been
discussed extensively on the forums and Telegram, be accompanied by a widely
...
about:
  ...
  - Finally, if all else fails, ask on Telegram or elsewhere for someone to give your pull request
