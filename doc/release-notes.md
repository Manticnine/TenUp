TENUP Core version *v4.0.2* is now available from:  <https://github.com/tenup-project/tenup/releases>
...
TENUP Core v4.0.2 is NOT a mandatory update, and user can choose to stay with v4.0.0/v4.0.1 if they wish. However, v4.0.2 does contain minor bug fixes and performance improvements to address feedback from the v4.0.0/v4.0.1 versions.
