...
TenUp Core is now available at `./src/tenupd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/TenUp"

    touch "/Users/${USER}/Library/Application Support/TenUp/tenup.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/TenUp/tenup.conf"

The first time you run tenupd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/tenupd -daemon # Starts the tenup daemon.
    ./src/tenup-cli --help # Outputs a list of command-line options.
    ./src/tenup-cli help # Outputs a list of RPC commands when the daemon is running.
