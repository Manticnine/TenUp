...
The script [extract-osx-sdk.sh](https://github.com/tenup-project/tenup/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
tenup/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/tenup-project/tenup/blob/master/doc/README_osx.md) for troubleshooting tips.