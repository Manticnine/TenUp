...
#ifndef TENUP_CORE_NEW_GUI_TENUPGUI_H
#define TENUP_CORE_NEW_GUI_TENUPGUI_H
...
*/
class TENUPGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit TENUPGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~TENUPGUI();
...
#endif //TENUP_CORE_NEW_GUI_TENUPGUI_H
