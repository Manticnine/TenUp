...
#ifndef TENUP_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define TENUP_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //TENUP_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
