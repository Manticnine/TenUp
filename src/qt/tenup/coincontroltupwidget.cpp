...
#include "qt/tenup/coincontroltupwidget.h"
#include "qt/tenup/forms/ui_coincontroltupwidget.h"

CoinControlTupWidget::CoinControlTupWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlTupWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select TUP Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("TUP");
    ...
    ui->labelValueAfter->setText("0.00 TUP");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 TUP");
    ui->labelValueFee->setText("0.00 TUP");
...
CoinControlTupWidget::~CoinControlTupWidget()
{
    delete ui;
}
