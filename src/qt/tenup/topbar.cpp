...
#include "qt/tenup/loadingdialog.h"
...
TopBar::TopBar(TUPXGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopTup}, "amount-small-topbar");
    setCssProperty({ui->labelAmountTup}, "amount-topbar");
    setCssProperty({ui->labelPendingTup, ui->labelImmatureTup}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // TUP Total
    QString totalTup = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    ui->labelPendingTup->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance, nDisplayUnit));
    ui->labelImmatureTup->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
