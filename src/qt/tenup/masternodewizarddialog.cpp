...
#include "qt/tenup/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 51482");
    ...
    if(walletModel->isTestNetwork()){
        ...
        ui->lineEditPort->setText("51484");
    } else {
        ui->lineEditPort->setText("51482");
    }
...
bool MasterNodeWizardDialog::createMN(){
    if (walletModel) {
        ...
        SendCoinsRecipient sendCoinsRecipient(QString::fromStdString(address.ToString()), QString::fromStdString(alias), CAmount(25000) * COIN, "");
