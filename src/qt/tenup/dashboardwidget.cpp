...
DashboardWidget::DashboardWidget(TUPXGUI* parent) :
    PWidget(parent),
...
bool hasCharts = false;
    ...
    if (window)
        connect(window, &TUPXGUI::windowResizeEvent, this, &DashboardWidget::windowResizeEvent);
#endif
...
void DashboardWidget::loadWalletModel()
{
    if (walletModel && walletModel->getOptionsModel()) {
        ...
        connect(ui->pushImgEmpty, &QPushButton::clicked, window, &TUPXGUI::openFAQ);
        connect(ui->btnHowTo, &QPushButton::clicked, window, &TUPXGUI::openFAQ);
