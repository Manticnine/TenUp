...
#include "config/tenup-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalTup = 0;
    qint64 totalZtup = 0;
    QList<qreal> valuesTup;
    QList<qreal> valueszTup;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(TUPXGUI* _window);
    ~DashboardWidget();
