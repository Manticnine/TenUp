...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, TUPXGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, TUPXGUI* gui, double posX = 3);
