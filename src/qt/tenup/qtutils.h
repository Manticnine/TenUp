...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, TENUPGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, TENUPGUI *gui, double posX = 3);
