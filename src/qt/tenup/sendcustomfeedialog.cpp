...
#include "qt/tenup/sendcustomfeedialog.h"
#include "qt/tenup/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(TUPXGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &TUPXGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
