...
#include "qt/tenup/coldstakingwidget.h"
#include "qt/tenup/forms/ui_coldstakingwidget.h"
#include "qt/tenup/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/tenup/requestdialog.h"
#include "qt/tenup/tooltipmenu.h"
...
ColdStakingWidget::ColdStakingWidget(TENUPGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your TUPs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept TUP delegation / Delegate TUP"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select TUP outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 TUP" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
