...
#include "qt/tenup/settings/settingsnetworkwidget.h"
#include "qt/tenup/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/tenup/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(TENUPGUI* _window, QWidget *parent) :
