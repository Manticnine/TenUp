...
#include "qt/tenup/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/tenup/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(TENUPGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to TENUPGUI::handleRestart()
