...
#include "qt/tenup/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/tenup/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(TUPXGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableTUP,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableTUP,
    ...
    connect(ui->pushButton_UnspendableTUP, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableTUP);});
    ...
    if (parent)
        connect(parent, &TUPXGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
