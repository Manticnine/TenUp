...
#include "qt/tenup/forms/ui_receivewidget.h"
...
#include "qt/tenup/addressholder.h"
...
ReceiveWidget::ReceiveWidget(TENUPGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive TUP."));
