...
QString formatBalance(CAmount amount, int nDisplayUnit, bool isZtup){
    return (amount == 0) ? ("0.00 " + BitcoinUnits::name(nDisplayUnit, isZtup)) : BitcoinUnits::floorHtmlWithUnit(nDisplayUnit, amount, false, BitcoinUnits::separatorAlways, true, isZtup);
}
...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter TENUP address (e.g. %1)").arg("D7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
