...
public:
    ...
    /// Get window identifier of QMainWindow (TENUPGUI)
...
{
    window = new TENUPGUI(networkStyle, 0);
...
void BitcoinApplication::initializeResult(int retval)
{
    ...
    if (retval) {
        ...
        if (pwalletMain) {
            ...
            window->addWallet(TENUPGUI::DEFAULT_WALLET, walletModel);
            window->setCurrentWallet(TENUPGUI::DEFAULT_WALLET);
...
{
    QMessageBox::critical(0, "Runaway exception", TENUPGUI::tr("A fatal error occurred. TENUP can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(1);
}
