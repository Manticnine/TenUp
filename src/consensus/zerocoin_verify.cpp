...
bool RecalculateTUPSupply(int nHeightStart, bool fSkipZtup)
{
    ...
    while (true) {
        ...
        // Rewrite ztup supply too
        if (!fSkipZtup && consensus.NetworkUpgradeActive(pindex->nHeight, Consensus::UPGRADE_ZC)) {
