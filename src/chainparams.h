...
public:
    ...
    int TenUpBadBlockTime() const { return nTenUpBadBlockTime; }
    int TenUpBadBlocknBits() const { return nTenUpBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nTenUpBadBlockTime;
    unsigned int nTenUpBadBlocknBits;
