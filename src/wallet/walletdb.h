...
// Copyright (c) 2016-2019 The TenUp developers
...
public:
    ...
    bool WriteZTUPSeed(const uint256& hashSeed, const std::vector<unsigned char>& seed);
    bool ReadZTUPSeed(const uint256& hashSeed, std::vector<unsigned char>& seed);
