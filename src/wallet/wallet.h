...
enum WalletFeature {
    ...
    FEATURE_PRE_TUPX = 61000, // inherited version..
...
enum ZerocoinSpendStatus {
    ...
    ZTUP_TXMINT_GENERAL = 9,                        // General errors in MintsToInputVectorPublicSpend
...
public:
    ...
    /// Get 25000 TUP output and keys which can be used for the Masternode
    ...
    void doZTupRescan(const CBlockIndex* pindex, const CBlock& block, std::set<uint256>& setAddedToWallet, const Consensus::Params& consensus, bool fCheckZTUP);
    ...
    // zTUP wallet
    std::unique_ptr<CzTUPTracker> ztupTracker{nullptr};
    void setZWallet(CzTUPWallet* zwallet);
    CzTUPWallet* getZWallet();
