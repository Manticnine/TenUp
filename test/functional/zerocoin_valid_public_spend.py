...
from fake_stake.base_test import TENUP_FakeStakeTest

class zTUPValidCoinSpendTest(TENUP_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zTUPs..." % DENOM_TO_USE)
