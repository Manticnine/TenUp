...
"""Verify that starting tenup with -h works as expected."""
import subprocess

from test_framework.test_framework import TenUpTestFramework
from test_framework.util import assert_equal

class HelpTest(TenUpTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tenup with -h for help text")
        ...
        self.log.info("Start tenup with -version for version information")
