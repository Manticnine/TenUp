...
class RawTransactionsTest(TenUpTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid tenup address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid tenup address" in e.error['message'])
